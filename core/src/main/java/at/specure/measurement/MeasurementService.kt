            ...
            TestUuidType.LOOP_UUID -> {
                ...
                io {
                    ...
                    historyRepository.loadHistoryItems(0, 100, true).onSuccess {
                        if (it.historyItems.isNotEmpty()) {
                            Timber.d("History Successfully loaded: ${it.historyItems[0].loopUUID} ${it.historyItems[0].speedDownload}  from size: ${it.historyItems.size}")
                        } else {
